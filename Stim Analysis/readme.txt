...
The default behavior of this script is to store the header information and data contained in the .rhs file in an object called 'a'.
This can be changed in the 'load_intan_rhs_format.py' file. The structure of this object is specified in the 'data_to_result.py' file.
