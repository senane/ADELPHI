function [Ypk,Xpk,Wpk,Ppk] = findpeaks_native(Yin,varargin)
% a copy of the native findpeaks matlab function with a different name
% to avoid conficts with chronux
